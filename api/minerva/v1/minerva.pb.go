...
type ParseSqlTypeReply struct {
	...
	Data    []*ParseSqlTypeReply_SqlCheckResult `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *ParseSqlTypeReply) GetData() []*ParseSqlTypeReply_SqlCheckResult {
	if x != nil {
		return x.Data
	}
	return nil
...
type ParseSqlTypeReply_SqlCheckResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ParseSqlTypeReply_SqlCheckResult) Reset() {
	*x = ParseSqlTypeReply_SqlCheckResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *ParseSqlTypeReply_SqlCheckResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ParseSqlTypeReply_SqlCheckResult) ProtoMessage() {}

func (x *ParseSqlTypeReply_SqlCheckResult) ProtoReflect() protoreflect.Message {
	mi := &file_minerva_v1_minerva_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ParseSqlTypeReply_SqlCheckResult.ProtoReflect.Descriptor instead.
func (*ParseSqlTypeReply_SqlCheckResult) Descriptor() ([]byte, []int) {
	return file_minerva_v1_minerva_proto_rawDescGZIP(), []int{1, 0}
}

func (x *ParseSqlTypeReply_SqlCheckResult) GetSql() string {
	if x != nil {
		return x.Sql
	}
	return ""
...
func (x *ParseSqlTypeReply_SqlCheckResult) GetSqlType() []string {
	if x != nil {
		return x.SqlType
	}
	return nil
...
func (x *ParseSqlTypeReply_SqlCheckResult) GetRisk() string {
	if x != nil {
		return x.Risk
	}
	return ""
...
var file_minerva_v1_minerva_proto_rawDesc = []byte{
	...
	0x73, 0x71, 0x6c, 0x22, 0xd6, 0x01, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x73, 0x65, 0x53, 0x71, 0x6c,
	...
	,
...
var file_minerva_v1_minerva_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_minerva_v1_minerva_proto_goTypes = []interface{}{
	...
	(*ParseSqlTypeReply_SqlCheckResult)(nil), // 2: minerva.v1.ParseSqlTypeReply.SqlCheckResult
}
var file_minerva_v1_minerva_proto_depIdxs = []int32{
	2, // 0: minerva.v1.ParseSqlTypeReply.data:type_name -> minerva.v1.ParseSqlTypeReply.SqlCheckResult
	0, // 1: minerva.v1.Minerva.ParseSqlType:input_type -> minerva.v1.ParseSqlTypeRequest
	1, // 2: minerva.v1.Minerva.ParseSqlType:output_type -> minerva.v1.ParseSqlTypeReply
...
func file_minerva_v1_minerva_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_minerva_v1_minerva_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParseSqlTypeReply_SqlCheckResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
